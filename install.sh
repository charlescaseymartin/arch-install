...
arch-chroot /mnt sh '$(curl -fsSL https://raw.githubusercontent.com/ohmyzsh/ohmyzsh/master/tools/install.sh)'
arch-chroot /mnt sh -c 'git clone https://github.com/charlescaseymartin/archlinux-moded-dotfiles.git'
arch-chroot /mnt sh -c 'cd archlinux-moded-dotfiles; install.sh -i'
